      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <a href="<?php echo base_url('admin/add_jurusan'); ?>" class="btn btn-neutral">Tambah</a>
  ...
  <div class="table-responsive">
                 ...
                 <td><div align="center"><?php echo $d['kelas']; ?>  </div></td>
               
                 <td> <div align="center"><a  class="btn btn-primary" href="<?php echo base_url('admin/edit_jurusan/'.$d['id_jurusan']);?>"><i class="fa fa-edit "></i></a> 
                                           <a onclick="return confirm('anda yakin ingin menghapus data ini')" class="btn btn-danger" href="<?php echo base_url('admin/delete_jurusan/'.$d['id_jurusan']);?>"><i class="fa fa-trash "></i></a>
                                         </div></td>
