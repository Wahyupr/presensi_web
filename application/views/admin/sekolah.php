      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <a href="<?php echo base_url('admin/add_sekolah'); ?>" class="btn btn-neutral">Tambah</a>
  ...
  <div class="table-responsive">
                         <table class="table table-striped table-bordered table-hover" id="example1">
                                    ...
                                    <thead>
                                        ...
                                        <th ><div align="center">Nama Sekolah</div></th>
                 ...
                 <td><div align="center"><?php echo $d['alamat_sekolah']; ?>  </div></td>
                 <td><div align="center"><?php echo $d['email']; ?>  </div></td>
                 <td><div align="center"><?php echo $d['telp']; ?>  </div></td>
                 <td> <div align="center"><a  class="btn btn-primary" href="<?php echo base_url('admin/edit_sekolah/'.$d['id_sekolah']);?>"><i class="fa fa-edit "></i></a> 
                                           <a onclick="return confirm('anda yakin ingin menghapus data ini')" class="btn btn-danger" href="<?php echo base_url('admin/delete_sekolah/'.$d['id_sekolah']);?>"><i class="fa fa-trash "></i></a>
                                         </div></td>
