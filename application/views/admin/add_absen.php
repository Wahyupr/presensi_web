          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Form Tambah Data Absensi</h3>
                </div>
  ...
  <?php echo validation_errors();
    echo form_open('admin/tambah_absen'); ?>
              ...
              ?>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="tgl_absensi" id="input-email" class="form-control" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="time" name="jam_masuk" id="input-first-name" class="form-control" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Checkout</label>
                        <input type="time" name="jam_keluar" id="input-last-name" class="form-control" >
                      </div>
                    </div>
                     <div class="col-lg-6">
                      <div class="form-group">
