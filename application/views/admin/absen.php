      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <a href="<?php echo base_url('admin/add_absen'); ?>" class="btn btn-neutral">Tambah</a>
  ...
  <div class="table-responsive">
                 ...
                 <td> <div align="center"><a  class="btn btn-primary" href="<?php echo base_url('admin/edit_absen/'.$d['id_absen']);?>"><i class="fa fa-edit "></i></a> 
                                           <a onclick="return confirm('anda yakin ingin menghapus data ini')" class="btn btn-danger" href="<?php echo base_url('admin/delete_absen/'.$d['id_absen']);?>"><i class="fa fa-trash "></i></a>
                                         </div></td>
