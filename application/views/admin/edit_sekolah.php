          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Form Edit Data Sekolah</h3>
                </div>
  ...
  <?php echo validation_errors();
    echo form_open('admin/update_sekolah'); ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_sekolah" value="<?php echo $d['nama_sekolah']; ?>"  class="form-control" >
                        <input type="hidden" name="id_sekolah" value="<?php echo $d['id_sekolah']; ?>"  class="form-control" >
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="alamat_sekolah" value="<?php echo $d['alamat_sekolah']; ?>" id="input-first-name" class="form-control" >
                      </div>
                    </div>
                       </div>
                      <div class="row">
                     <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="telp" value="<?php echo $d['telp']; ?>" id="input-last-name" class="form-control" >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Email</label>
                        <input type="text" name="email" value="<?php echo $d['email']; ?>" id="input-last-name" class="form-control" >
                      </div>
                    </div>
